...
public class UsersManagementController implements Initializable {
    ...
    void generateFakeData() {
        ...
        users.add(new User(1, "John", "Doe", true, "A101", 20230101, "Male",false));
        users.add(new User(2, "Jane", "Smith", false, "B202", 20230215, "Female",false));
        users.add(new User(3, "Michael", "Johnson", true, "C303", 20220120, "Male",false));
        users.add(new User(4, "Emily", "Davis", true, "D404", 20231010, "Female",false));
        users.add(new User(5, "Chris", "Brown", false, "E505", 20221105, "Male",false));
        users.add(new User(6, "Sophia", "Taylor", true, "F606", 20211212, "Female",false));
        users.add(new User(7, "Daniel", "Wilson", true, "G707", 20230530, "Male",false));
        users.add(new User(8, "Olivia", "Moore", false, "H808", 20230808, "Female",false));
        users.add(new User(9, "Ethan", "Thomas", true, "I909", 20210621, "Male",false));
        users.add(new User(10, "Isabella", "Harris", false, "J010", 20231115, "Female",false));
